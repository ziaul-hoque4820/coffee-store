    ...
    return (
        <div className='p-24'>
            ...
            <div className="w-full max-w-6xl mb-6">
                <Link
                    to="/"
                    className="text-gray-700 font-bold hover:text-black transition font-heading text-xl  flex items-center gap-1"
                >
            ...
            <form onSubmit={handleUpdateCoffee}>
                ...
                <input type="submit" className='btn w-full bg-[#D2B48C] text-white font-heading text-xl rounded-[5px] border border-transparent hover:bg-[#b49d7e] hover:border-[#cab495] transition-all duration-300 cursor-pointer' value="Update Coffee" />
            </form>
        </div>
    )
}
